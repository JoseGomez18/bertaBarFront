...
import { ArrowRight, Clock, Coffee, Utensils, Plus, ChevronDown, ChevronUp } from "lucide-react"
import { OrderDetails } from "./order-details"
import { OrderForm } from "./order-form"
import { useEffect, useState } from "react"
import { useStore } from "../../lib/store"
import type { Order } from "@/src/types/inventario"
                    ...
                    <div className="mb-3">
                      ...
                      <ul className="space-y-1">
                        {order.productos && Array.isArray(order.productos) ? (
                          ...
                          <li className="text-sm text-muted-foreground">No hay productos</li>
                        )}
                      </ul>
                    </div>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-1 text-sm">
                        ...
                        <span className="text-xs font-medium">
                          {order.productos && Array.isArray(order.productos)
                            ? order.productos.reduce((sum, item) => sum + item.cantidad, 0)
                            : 0}{" "}
                          items
                        </span>
                      </div>
